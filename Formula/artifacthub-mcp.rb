class ArtifacthubMcp < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "1111111111111111111111111111111111111111111111111111111111111111" # sha-update-id: artifacthub-mcp-aarch64-apple-darwin
    else
      url "#{homepage}/releases/download/v#{version}/artifacthub-mcp-#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "2222222222222222222222222222222222222222222222222222222222222222" # sha-update-id: artifacthub-mcp-x86_64-apple-darwin
    end
  end
